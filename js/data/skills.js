...
(function () {
  ...
  const skills = {
    ...
    warlord_dominance: {
      ...
      effect: (lv) => ({ attackBonus: lv * 3, defenseBonus: lv * 3 }),
    },
    warlord_charge: {
      name: "突撃",
      type: "active",
    ...
    warlord_banner: {
      ...
      effect: (lv) => ({ defenseBonus: lv * 3, accuracyBonus: lv * 2 }),
    },
    warlord_judgement: {
      name: "断罪撃",
      type: "active",
    ...
    warlord_style_lance: {
      ...
      desc: "攻撃力+{attackBonus}%（命中+{accuracyBonus}%）",
      effect: (lv) => ({ attackBonus: lv * 4, accuracyBonus: lv * 2 }),
    },
    warlord_style_shield: {
      ...
      effect: (lv) => ({ defenseBonus: lv * 4, counterChanceBonus: lv * 2 }),
    },
