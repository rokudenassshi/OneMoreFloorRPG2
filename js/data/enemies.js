...
(function () {
  ...
  const monsterTypes = [
    ...
    },
    {
      ...
      minFloor: 801,
      maxFloor: 1000,
      skills: ["multi_slash", "bite_poison", "doom_mark", "power_strike"],
    },
    {
      name: "原初の終末",
      hp: 28500,
    ...
    },
    {
      ...
      minFloor: 1001,
      maxFloor: 1500,
      skills: ["thunder_strike", "multi_slash", "silence_hex", "doom_mark"],
    },
    {
      name: "天滅の機神",
      hp: 52000,
    ...
    },
    {
      ...
      minFloor: 1501,
      maxFloor: 2000,
      skills: ["crushing_blow", "silence_hex", "doom_mark", "heal"],
    },
    {
      name: "無窮の戦神",
      hp: 84000,
    ...
    },
    {
      ...
      minFloor: 3001,
      maxFloor: 4500,
      skills: ["fireball", "crushing_blow", "silence_hex", "doom_mark", "heal"],
    },
    {
      name: "天壊の終末炉",
      hp: 278000,
  ...
  function getAsuraTierAverage(maxFloor) {
    return (
      asuraTierAverages.find((c) => maxFloor <= c.maxFloor) ||
      asuraTierAverages[asuraTierAverages.length - 1]
    );
  }
